...
class CatalogController extends AppController {
    ...
    public function actionBrand($id) {
        ...
        return $this->render(
                        'brand', compact('brand', 'products', 'pages')
        );
    }
    ...
    public function actionProduct($id) {
        ...
        if ($data === false) {
            ...
            if (empty($product)) {
                throw new \yii\web\HttpException(404, 'Товара не существует!');
            }
        ...
        return $this->render(
                        'product', compact('product', 'brand', 'similar', 'category')
        );
    }
